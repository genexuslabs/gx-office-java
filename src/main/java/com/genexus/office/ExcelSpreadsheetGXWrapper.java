...
public class ExcelSpreadsheetGXWrapper implements IGxError
{
	...
	public Boolean insertRow(int rowIdx, int rowCount)
	{
		if (isOK())
		{
			return _document.insertRow(_currentWorksheet, rowIdx, rowCount);
		}
		return false;
	}
	...
	public Boolean insertColumn(int colIdx, int colCount)
	{
		...
		/*if (isOK())
		{
			//return _document.(_currentWorksheet, colIdx, colCount);
		}
		return false;*/
	}

	public Boolean deleteRow(int rowIdx, int rowCount)
	{
		if (isOK())
		{
			return _document.deleteRow(_currentWorksheet, rowIdx);
		}
		return false;
	}

	/*
	 * public Boolean deleteColumn(int colIdx, int colCount) { if (isOK()) { return
	 * _document.deleteColumn(_currentWorksheet, colIdx, colCount); } return false;
	 * }
	 */
